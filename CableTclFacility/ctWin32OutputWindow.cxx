/*=========================================================================
  ...
  Module:    ctWin32OutputWindow.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
bool Win32OutputWindow::Initialize()
{
  ...
  if (!GetClassInfo(GetModuleHandle(0),
                    "_cable_tcl_::Win32OutputWindow",&wndClass))
    {
    ...
    wndClass.lpszClassName = "_cable_tcl_::Win32OutputWindow";
  ...
  HWND win = CreateWindow(
    "_cable_tcl_::Win32OutputWindow", "_cable_tcl_::Win32OutputWindow",
